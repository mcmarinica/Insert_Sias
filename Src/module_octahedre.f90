...
module icosaedre
   ...
   real(8), dimension(2,3,3) :: rdumb
   real(8), dimension(:,:), allocatable :: r_extra_ico, rx_reshape, ry_reshape, rz_reshape
   integer, dimension(:), allocatable :: nsite_dumb_remove, type_dumb
   integer :: nsia_ico, nsia_dumbell,   nsia_dumbell_real_ico, nsia_center_real_ico
   ! nsia_dumbell = nsia_dumbell_real_ico, nsia_center_real_ico
