      ...
      !old parameter (a0=2.8553,as110=2.148d0,as111=2.12d0,as100=2.1d0)
      parameter (a0=2.8553,as110=1.6,as111=1.6d0,as100=1.6d0)
      ...
      integer,dimension(:),allocatable :: ns1(:),ns2(:),ns3(:),nsite(:),&
                                           nicnt
      double precision     :: rsx(2),rsy(2),rsz(2), deca(3)
...
!        normal of the plane
	      ...
	      if (bshape==2) then
	          ...
	          write(*,*) 'Put the radius.......................>'
               read(*,*) rcirc
	         call count_cut_circ(nsolid,rcirc,nplane,iloop,nicnt,rxc,ryc,rzc,rxloop,ryloop,rzloop)
            end if
	      ...
	      if (bshape==3) then
	         ...
	         zmax=MAXVAL(rz)/2.0
	         zmin=MINVAL(rz)/2.0
	         write(*,*) 'The radius must be smaller than......:', xmax-xmin,ymax-ymin,zmax-zmin
!	  write(*,*) 'Without interaction smaller than.....:'
		   ...
		   call count_cut_hex(nsolid,side,nplane,iloop,nv,nv1,nv2,nv3,nv4,nv5,nv6,nicnt,rxc,ryc,rzc,rxloop,ryloop,rzloop)
            end if
      end if
...
!	  write(*,*) 'Without interaction smaller than.....:'
      ...
      if (hplane==3) then
	      ...
	      if (bshape==2) then
	            ...
	            write(*,*) 'The radius must be smaller than......:', rxmax-rxmin,rymax-rymin
	            write(*,*) 'Put the radius.......................>'
                  read(*,*) rcirc
...
!.....................................................................
      if (biplane==2) then
 	      ...
 	      if (hplane==1) then
 	            ...
 	            do i=nsia/2+1,nsia
 	                rxloop2(i)= rxloop(i-nsia/2)+deca(1)*a0/2
 	                ryloop2(i)= ryloop(i-nsia/2)+deca(2)*a0/2
 	                rzloop2(i)= rzloop(i-nsia/2)+deca(3)*a0/2
 	            end do
 	            ...
 	            do i=nsia/2+1,nsia
 	               ...
 	               ryloop2(i)= ryloop(i-nsia/2)+deca(2)*a0/2
                     !orig
 	               !orig rzloop2(i)= rzloop(i-nsia/2)-deca(3)*a0/2
 	               rzloop2(i)= rzloop(i-nsia/2)+deca(3)*a0/2
 	            end do
